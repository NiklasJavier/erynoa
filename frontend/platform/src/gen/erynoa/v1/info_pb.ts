...
/**
 * @generated from message erynoa.v1.GetInfoRequest
 */
export class GetInfoRequest extends Message<GetInfoRequest> {
  ...
  static readonly typeName = "erynoa.v1.GetInfoRequest";
...
/**
 * @generated from message erynoa.v1.GetInfoResponse
 */
export class GetInfoResponse extends Message<GetInfoResponse> {
  ...
  /**
   * @generated from field: erynoa.v1.AuthConfig auth = 3;
   */
  auth?: AuthConfig;

  /**
   * @generated from field: erynoa.v1.UrlConfig urls = 4;
   */
  urls?: UrlConfig;

  /**
   * @generated from field: erynoa.v1.FeatureFlags features = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "erynoa.v1.GetInfoResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message erynoa.v1.AuthConfig
 */
export class AuthConfig extends Message<AuthConfig> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "erynoa.v1.AuthConfig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message erynoa.v1.UrlConfig
 */
export class UrlConfig extends Message<UrlConfig> {
  /**
   * @generated from field: string console = 1;
   */
  console = "";
  ...
  /**
   * @generated from field: string docs = 3;
   */
  docs = "";
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "erynoa.v1.UrlConfig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "console", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "platform", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "docs", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message erynoa.v1.FeatureFlags
 */
export class FeatureFlags extends Message<FeatureFlags> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "erynoa.v1.FeatureFlags";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [

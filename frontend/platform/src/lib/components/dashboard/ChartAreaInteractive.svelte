<script lang="ts">
  ...
  import * as Select from "@erynoa/ui/components/select";
...
<Card.Root class="@container/card">
  <Card.Header
    class="flex flex-col space-y-0 border-b py-5 sm:flex-row sm:items-center sm:justify-between sm:py-6"
  >
  ...
  <Card.Content class="px-2 pt-4 sm:px-6 sm:pt-6">
    ...
    <div
      class="aspect-auto h-[250px] w-full flex items-center justify-center rounded-lg bg-muted/50"
    >

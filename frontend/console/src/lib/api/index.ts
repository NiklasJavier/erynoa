...
export const api = {
  get users() { return import('./clients').then(m => m.userClient()); },
  get health() { return import('./clients').then(m => m.healthClient()); },
  get info() { return import('./clients').then(m => m.infoClient()); },
  get storage() { return import('./clients').then(m => m.storageClient()); },
};

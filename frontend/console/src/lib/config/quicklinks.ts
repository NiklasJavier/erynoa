...
import { navigationConfig, hasChildren, getEntryUrl, type NavEntry, type NavGroup } from './navigation';
 ...
 */
function findNavEntryByUrl(entries: NavEntry[], url: string): { entry: NavEntry; group?: NavGroup } | null {

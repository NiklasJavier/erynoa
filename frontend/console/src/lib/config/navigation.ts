...
export const navigationConfig: NavConfig = {
	...
	topItems: [{ title: 'Dashboard', url: '/', icon: LayoutDashboard }],
	groups: [
		// ========================================
 ...
 */
function getMaxDepthRecursive(entries: NavEntry[], currentDepth = 0): number {

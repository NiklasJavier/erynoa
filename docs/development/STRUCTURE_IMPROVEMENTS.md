...
### 2. Frontend: Config-Dateien konsolidieren (Medium Priority)
...
### 5. Frontend: API-Types vereinfachen (Low Priority)
...
2. ✅ **Frontend: Config konsolidieren** - **ABGESCHLOSSEN** ✅
...
5. ✅ **Frontend: API-Types vereinfachen** - **ABGESCHLOSSEN** ✅
...
### Schritt 2: Frontend Config konsolidieren
```bash
...
- Frontend: 2 Dateien weniger (Config)

...
<div class="setting-line">\
	...
	function buildSettingsPage() {
		...
		const settings = [
			...
			{ name: 'Hide persistent navigation bar', js_name: 'hide-sidebar', default: false },
			{ name: 'Hide table of contents', js_name: 'hide-toc', default: false },
			{ name: 'Hide module navigation', js_name: 'hide-modnav', default: false },
			{ name: 'Disable keyboard shortcuts', js_name: 'disable-shortcuts', default: false },
			{ name: 'Use sans serif fonts', js_name: 'sans-serif-fonts', default: false },
			{ name: 'Word wrap source code', js_name: 'word-wrap-source-code', default: false },
		]

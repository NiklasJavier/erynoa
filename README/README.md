...
- **[Setup](guides/setup.md)** - Entwicklungsumgebung einrichten
...
- **[Structure Improvements](development/STRUCTURE_IMPROVEMENTS.md)** - Strukturverbesserungen
...
3. Folge [Setup](guides/setup.md) für Entwicklungsumgebung
...
- [Setup](guides/setup.md) - Deployment-Konfiguration

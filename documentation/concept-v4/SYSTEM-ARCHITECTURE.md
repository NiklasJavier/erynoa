...
graph TD
    subgraph "Client / Peer Layer"
        ...
        B --> C[Intent Parser]
        C --> D[Saga Composer<br/>Κ22]
        D --> E[Gateway Guard<br/>Κ23]
    end

    subgraph "Core Logic Layer"
        E --> F[Event Engine<br/>Causal DAG Κ9-Κ12]
        F --> G[Trust Engine<br/>𝕋 Funktor, 𝕎 Vektor Κ2-Κ5]
        G --> H[Surprisal Calculator<br/>ℐ Sketch, 𝒮 Dämpfung Κ15a]
        H --> I[World Formula Engine<br/>𝔼 Berechnung Κ15b-d]
        I --> J[Consensus Engine<br/>Ψ Partition-Konsens Κ18]
    end

    subgraph "Storage / Realm Layer"
        F --> K[Event Store<br/>Immutable DAG]
        G --> L[Identity Store<br/>DIDs, Delegation ⊳]
        I --> M[Realm Hierarchy<br/>Root → Virtual → Partition Κ1]
        M --> K
    end

    subgraph "Protection Layer"
        I --> N[Anti-Degeneration<br/>Κ19-Κ21]
        J --> N
    end
